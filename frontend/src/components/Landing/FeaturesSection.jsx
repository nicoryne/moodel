...
import auth from "../../assets/features/auth.png";
import professor from "../../assets/features/professor.png";
        ...
        <div className="flex flex-wrap justify-center gap-8">
          ...
          <div className="w-full transform rounded-lg bg-white p-6 shadow-lg transition-transform hover:scale-105 md:w-1/3">
            <div className="flex items-center gap-4">
              <img src={auth} alt="User Authentication" className="h-12 w-12 rounded-lg" />
              <div>
          ...
          <div className="w-full transform rounded-lg bg-white p-6 shadow-lg transition-transform hover:scale-105 md:w-1/3">
            <div className="flex items-center gap-4">
              <img src={profile} alt="Personalized User Profiles" className="h-12 w-12 rounded-lg" />
              <div>
          ...
          <div className="w-full transform rounded-lg bg-white p-6 shadow-lg transition-transform hover:scale-105 md:w-1/3">
            <div className="flex items-center gap-4">
              <img src={student} alt="Student Submissions Dashboard" className="h-12 w-12 rounded-lg" />
              <div>
          ...
          <div className="w-full transform rounded-lg bg-white p-6 shadow-lg transition-transform hover:scale-105 md:w-1/3">
            <div className="flex items-center gap-4">
              <img src={professor} alt="Teacher Project Dashboard" className="h-12 w-12 rounded-lg" />
              <div>
          ...
          <div className="w-full transform rounded-lg bg-white p-6 shadow-lg transition-transform hover:scale-105 md:w-1/3">
            <div className="flex items-center gap-4">
              <img src={ai} alt="Predictive Submission Management Assistant" className="h-12 w-12 rounded-lg" />
              <div>
